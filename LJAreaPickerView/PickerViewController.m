...
- (void)didClickArea{
    ...
    if (self.pickerBackGround) {
        ...
        self.pickerBackGround = [[UIView alloc]initWithFrame:CGRectMake(0, (SCREEN_HEIGHT ), SCREEN_WIDTH, 216)];
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 30, self.pickerBackGround.bounds.size.width, self.pickerBackGround.bounds.size.height-30)];
